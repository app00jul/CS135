...
(define (transitive-closure R)
  (loop R R (cardinality R)
   )
  )

(define (loop R S iteration)
  (cond [(equal? iteration 0) S]
        [else (loop R (union S (compose R S)) (- iteration 1))]
   )
  )
...
#| Implement "equivalence?" to accept a relation R and a positive integer n
 ...
 |   (equivalence? '((2 2)) 2 )
 |     -> #f
 |   (equivalence? '((1 1) (1 2) (1 3) (2 1) (2 2) (2 3) (3 1) (3 2) (3 3)) 3 )
 |     -> #t
 |   (equivalence? '((1 1) (1 2) (2 1)) 2 )
 |     -> #f
 |   (equivalence? '((1 1) (2 2) (3 3) (4 4) (3 4) (4 3)) 4 )
 |     -> #t
 |   (equivalence? '((1 1) (2 3) (3 2)) 1 )
 |     -> #f    [Do you see why this is false despite being reflexive up to 1?]
 |   (equivalence? '((1 1) (2 4) (4 2) (2 2) (4 4)) 1 )
 |     -> #t
 |   (equivalence? '((1 1) (2 4) (4 2) (2 2) (4 4)) 4 )
 |     -> #f    [In comparison to the previous example, this fails because (3 3) is missing]
 |#

;; Type signature: (equivalence? relation positive-int) -> boolean
;; 4 PTS
(define (equivalence? R n)
  (cond [(reflexive? n R)
         (cond [(transitive? R)
                (cond [(symmetric? R) #t]
                      [else #f])]
...
(define (surjective? R num)
  (cond [(equal? num 0) #t]
        [(element? (surjective_helper R) num) (surjective? R (- num 1))]
        [else #f]
   )
  )

(define (surjective_helper R)
  (cond [(null? R) '()]
        [else (append (surjective_helper (cdr R)) (list (car (cdr (car R)))))]
   )
  )
